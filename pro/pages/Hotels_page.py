...
def create_hotel_selection_section(df):
    ...
    for hotel in hotel_stats.sort_values('review_count', ascending=False).index:
        ...
        count = hotel_stats.loc[hotel, 'review_count']        # Updated emoji logic for 0-100 scale
        if sentiment >= 80:
            emoji = "🌟"
        elif sentiment >= 65:
            emoji = "👍"
    ...
    return html.Div([
        ...
        # KPI Metrics Row - positioned under the dropdown
        dbc.Row([
            dbc.Col([
        ...
        html.Div(id="hotel-detailed-content")    ], className="hotel-selection-section mb-4")
...
def create_all_hotels_overview_metrics(df):
    """Create compact overview metrics for all hotels"""
    ...
    if 'Hotel Name' in df.columns and 'sentiment_numeric' in df_numeric.columns:
        hotel_avg_sentiment = df_numeric.groupby('Hotel Name')['sentiment_numeric'].mean()
        top_rated_hotel = hotel_avg_sentiment.idxmax() if not hotel_avg_sentiment.empty else ""
                    ...
                    dbc.CardBody([
                        html.Div([                            html.Div([
                                html.I(className="fas fa-hotel", 
                                      style={'fontSize': '1.4rem', 'color': '#6366F1', 'marginBottom': '0.2rem'}),
                            ], className="compact-kpi-icon-container"),
                            html.H6("Total Hotels", className="compact-kpi-card-title"),
                            html.H4(f"{total_hotels}", className="compact-kpi-card-value")
                        ], className="compact-kpi-card-content")
                    ], className="compact-kpi-card-body")
                ], className="compact-kpi-stat-card compact-kpi-hotels-card")
            ], width=3, className="compact-kpi-card-column"),
                    ...
                    dbc.CardBody([
                        html.Div([                            html.Div([
                                html.I(className="fas fa-comments", 
                                      style={'fontSize': '1.4rem', 'color': '#10B981', 'marginBottom': '0.2rem'}),
                            ], className="compact-kpi-icon-container"),
                            html.H6("Total Reviews", className="compact-kpi-card-title"),
                            html.H4(f"{total_reviews:,}", className="compact-kpi-card-value")
                        ], className="compact-kpi-card-content")
                    ], className="compact-kpi-card-body")
                ], className="compact-kpi-stat-card compact-kpi-reviews-card")
            ], width=3, className="compact-kpi-card-column"),
                    ...
                    dbc.CardBody([
                        html.Div([                            html.Div([
                                html.I(className="fas fa-star", 
                                      style={'fontSize': '1.4rem', 'color': '#F59E0B', 'marginBottom': '0.2rem'}),
                            ], className="compact-kpi-icon-container"),
                            html.H6("Avg Sentiment", className="compact-kpi-card-title"),
                            html.H4(f"{avg_sentiment:.1f}/100", className="compact-kpi-card-value")
                        ], className="compact-kpi-card-content")
                    ], className="compact-kpi-card-body")
                ], className="compact-kpi-stat-card compact-kpi-sentiment-card")
            ], width=3, className="compact-kpi-card-column"),
                    ...
                    dbc.CardBody([
                        html.Div([                            html.Div([
                                html.I(className="fas fa-trophy", 
                                      style={'fontSize': '1.4rem', 'color': '#8B5CF6', 'marginBottom': '0.2rem'}),
                            ], className="compact-kpi-icon-container"),
                            html.H6("Top Rated", className="compact-kpi-card-title"),
                            html.P(top_rated_hotel[:12] + "..." if len(top_rated_hotel) > 15 else top_rated_hotel, 
                                   className="compact-kpi-card-value", 
                                   style={'fontSize': '0.9rem', 'lineHeight': '1.2', 'margin': '0'})
                        ], className="compact-kpi-card-content")
                    ], className="compact-kpi-card-body")
                ], className="compact-kpi-stat-card compact-kpi-top-card")
            ], width=3, className="compact-kpi-card-column")
        ], className="compact-kpi-cards-row")
    ])

def create_single_hotel_overview_metrics(hotel_df, hotel_name):
    """Create compact overview metrics for a single hotel"""
    if hotel_df.empty:
        ...
        dbc.Row([
                ...
                dbc.Card([
                    dbc.CardBody([
                        html.Div([                            html.Div([
                            ...
                            html.H6("Reviews", className="compact-kpi-card-title"),
                            html.H4(f"{review_count}", className="compact-kpi-card-value")
                        ], className="compact-kpi-card-content")
                    ], className="compact-kpi-card-body")
                ], className="compact-kpi-stat-card compact-kpi-reviews-card")
            ], width=3, className="compact-kpi-card-column"),
                ...
                dbc.Card([
                    dbc.CardBody([
                        html.Div([                            html.Div([
                            ...
                            html.H6("Consistency", className="compact-kpi-card-title"),
                            html.H4(f"±{sentiment_std:.1f}", className="compact-kpi-card-value")
                        ], className="compact-kpi-card-content")
                    ], className="compact-kpi-card-body")
                ], className="compact-kpi-stat-card compact-kpi-consistency-card")
            ], width=3, className="compact-kpi-card-column"),
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.Div([                            html.Div([
                                html.I(className=perf_icon, 
                                      style={'fontSize': '1.4rem', 'color': perf_color, 'marginBottom': '0.2rem'}),
                            ], className="compact-kpi-icon-container"),
                            html.H6("Performance", className="compact-kpi-card-title"),
                            html.P(performance, 
                                   className="compact-kpi-card-value",
                                   style={'fontSize': '0.9rem', 'lineHeight': '1.2', 'margin': '0'})
                        ], className="compact-kpi-card-content")
                    ], className="compact-kpi-card-body")
                ], className="compact-kpi-stat-card compact-kpi-performance-card")
            ], width=3, className="compact-kpi-card-column")
        ], className="compact-kpi-cards-row")
    ])
                ...
                dbc.CardBody([
                    dbc.Row([
                        ...
                        dbc.Col([
                            ...
                            ], color=perf_color, className="mb-2"),                            html.Small("Based on sentiment analysis", className="text-muted")
                        ], md=4)
                    ])
                ])
            ], className="mb-4")
...
def create_single_hotel_sentiment_content(hotel_df, hotel_name):
    ...
    try:
        ...
        # Single hotel sentiment analysis (removed timeline chart)
        ...
        return html.Div([
            dbc.Row([
                ...
                dbc.Col([
                    html.Div([
                        ...
                        html.P([
                            "📊 ",
                            html.Strong("Sentiment Score Explanation: "),
                            "Scores range from 0-100, where 0-40 is negative sentiment (red), 40-60 is neutral (orange), and 60-100 is positive sentiment (green). Higher scores indicate more positive guest experiences."
            ...
            # Enhanced Sentiment by Nationality Section
            dbc.Row([
                dbc.Col([
                    html.Div([
                        html.H5(f"🌍 Sentiment by Nationality - {hotel_name}", className="chart-title"),
                        html.Div([
                            dbc.Alert([
                                html.H6([
                                    html.I(className="fas fa-info-circle me-2"),
                                    "Nationality Sentiment Analysis"
                                ], className="alert-heading"),
                                html.P([
                                    "This analysis shows the average sentiment scores (0-100 scale) for different nationalities visiting this hotel. ",
                                    html.Strong("Green bars (60-100)"), " indicate positive experiences, ",
                                    html.Strong("orange bars (40-60)"), " show neutral feedback, and ",
                                    html.Strong("red bars (0-40)"), " represent negative experiences."
                                ], className="mb-2"),
                                html.Small([
                                    html.I(className="fas fa-chart-bar me-1"),
                                    "Only nationalities with 2+ reviews are displayed for statistical relevance."
                                ], className="text-muted")
...
def analyze_nationality_preferences(hotel_df, hotel_name):
    ...
    try:
        ...
        top_nationalities = nationality_counts[nationality_counts >= 1].head(10).index
...
def create_single_hotel_demographics_content(hotel_df, hotel_name):
    ...
    try:
        ...
        # Nationality preferences analysis
...
def create_all_hotels_comparative_content(df):
    """Create simplified comparative analysis overview - KPIs only"""
    try:
        if df.empty:
        ...
        # Calculate hotel rankings
        if 'Hotel Name' in df.columns and 'sentiment_numeric' in df_numeric.columns:
            hotel_rankings = df_numeric.groupby('Hotel Name').agg({
                'sentiment_numeric': 'mean',
                'Hotel Name': 'count'
            }).rename(columns={'Hotel Name': 'review_count'}).sort_values('sentiment_numeric', ascending=False)
            
            best_hotel = hotel_rankings.index[0] if not hotel_rankings.empty else "N/A"
            best_hotel_score = hotel_rankings.iloc[0]['sentiment_numeric'] if not hotel_rankings.empty else 0
            avg_hotel_score = hotel_rankings['sentiment_numeric'].mean()
            
            # Calculate city performance
            if 'City' in df.columns:
                city_performance = df_numeric.groupby('City')['sentiment_numeric'].mean().sort_values(ascending=False)
                best_city = city_performance.index[0] if not city_performance.empty else "N/A"
                best_city_score = city_performance.iloc[0] if not city_performance.empty else 0
            else:
                best_city = "N/A"
                best_city_score = 0
        else:
                            ...
                            html.Div([
                                html.Div([
                                    html.I(className="fas fa-crown", 
                                          style={'fontSize': '2.5rem', 'color': '#FFD700', 'marginBottom': '0.5rem'}),
                                ], className="hotel-kpi-icon-container"),
                                html.H4("Best Hotel", className="hotel-kpi-card-title"),
                                html.H3(best_hotel[:15] + "..." if len(str(best_hotel)) > 18 else str(best_hotel), 
                                       className="hotel-kpi-card-value",
                                       style={'fontSize': '1.4rem', 'lineHeight': '1.2'})
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-best-hotel-card")
                ], width=3, className="hotel-kpi-card-column"),
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            html.Div([
                                html.Div([
                                    html.I(className="fas fa-star", 
                                          style={'fontSize': '2.5rem', 'color': '#FF8C42', 'marginBottom': '0.5rem'}),
                                ], className="hotel-kpi-icon-container"),
                                html.H4("Best Score", className="hotel-kpi-card-title"),
                                html.H2(f"{best_hotel_score:.1f}/100", className="hotel-kpi-card-value")
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-best-score-card")
                ], width=3, className="hotel-kpi-card-column"),
                            ...
                            html.Div([
                                html.Div([
                                    html.I(className="fas fa-map-marked-alt", 
                                          style={'fontSize': '2.5rem', 'color': '#51CF66', 'marginBottom': '0.5rem'}),
                                ], className="hotel-kpi-icon-container"),
                                html.H4("Best City", className="hotel-kpi-card-title"),
                                html.H3(str(best_city), className="hotel-kpi-card-value",
                                       style={'fontSize': '1.6rem', 'lineHeight': '1.2'})
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-best-city-card")
                ], width=3, className="hotel-kpi-card-column"),
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            html.Div([
                                html.Div([
                                    html.I(className="fas fa-chart-line", 
                                          style={'fontSize': '2.5rem', 'color': '#20E3B2', 'marginBottom': '0.5rem'}),
                                ], className="hotel-kpi-icon-container"),
                                html.H4("Avg Performance", className="hotel-kpi-card-title"),
                                html.H2(f"{avg_hotel_score:.1f}/100", className="hotel-kpi-card-value")
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-avg-performance-card")
                ], width=3, className="hotel-kpi-card-column")
            ], className="hotel-kpi-cards-row"),
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Alert([
                        ...
                        html.P([
                            f"Across {total_hotels} hotels in {total_cities} cities, ",
                            html.Strong(f"{best_hotel}"), f" leads with a score of {best_hotel_score:.1f}/100. ",
                            html.Strong(f"{best_city}"), f" is the top-performing city with an average score of {best_city_score:.1f}/100. ",
                            f"The overall average performance across all hotels is {avg_hotel_score:.1f}/100."
                        ], className="mb-0")
...
def create_single_hotel_comparative_content(df, hotel_name):
    """Create simplified comparative analysis for a single hotel - KPIs and Market Position only"""
    try:
        if df.empty:
            return html.Div("No data available for comparative analysis", className="text-muted p-3")
        ...
        df_numeric = convert_sentiment_to_numeric(df)
        hotel_df_numeric = convert_sentiment_to_numeric(hotel_df)
        city_hotels_df_numeric = convert_sentiment_to_numeric(city_hotels_df)
        
        # Calculate KPI metrics
        hotel_avg_sentiment = hotel_df_numeric['sentiment_numeric'].mean() if 'sentiment_numeric' in hotel_df_numeric.columns else 0
        city_avg_sentiment = city_hotels_df_numeric['sentiment_numeric'].mean() if 'sentiment_numeric' in city_hotels_df_numeric.columns else 0
        hotel_reviews = len(hotel_df)
        city_total_reviews = len(city_hotels_df)
        
        # Calculate hotel's market share in the city
        market_share = (hotel_reviews / city_total_reviews * 100) if city_total_reviews > 0 else 0
        
        # Calculate ranking in city
        city_hotel_rankings = city_hotels_df_numeric.groupby('Hotel Name')['sentiment_numeric'].mean().sort_values(ascending=False)
        hotel_rank = list(city_hotel_rankings.index).index(hotel_name) + 1 if hotel_name in city_hotel_rankings.index else "N/A"
        total_hotels_in_city = len(city_hotel_rankings)
                            ...
                            html.Div([
                                html.Div([
                                    html.I(className="fas fa-chart-bar", 
                                          style={'fontSize': '2.5rem', 'color': '#4C6EF5', 'marginBottom': '0.5rem'}),
                                ], className="hotel-kpi-icon-container"),
                                html.H4("City Ranking", className="hotel-kpi-card-title"),
                                html.H2(f"#{hotel_rank}", className="hotel-kpi-card-value")
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-ranking-card")
                ], width=3, className="hotel-kpi-card-column"),
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            html.Div([
                                ...
                                html.H4("Market Share", className="hotel-kpi-card-title"),
                                html.H2(f"{market_share:.1f}%", className="hotel-kpi-card-value")
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-market-share-card")
                ], width=3, className="hotel-kpi-card-column"),
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            html.Div([
                                ...
                                html.H4("vs City Avg", className="hotel-kpi-card-title"),
                                html.H2(f"{hotel_avg_sentiment - city_avg_sentiment:+.1f}", className="hotel-kpi-card-value")
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-vs-city-card")
                ], width=3, className="hotel-kpi-card-column"),
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            html.Div([
                                ...
                                html.H4("Total Competitors", className="hotel-kpi-card-title"),
                                html.H2(f"{total_hotels_in_city}", className="hotel-kpi-card-value")
                            ], className="hotel-kpi-card-content")
                        ], className="hotel-kpi-card-body")
                    ], className="hotel-kpi-stat-card hotel-kpi-competitors-card")
                ], width=3, className="hotel-kpi-card-column")
            ], className="hotel-kpi-cards-row"),
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        ...
                        html.P([
                            "📊 This scatter plot shows how this hotel performs compared to competitors in the same city. ",
                            html.Strong("X-axis: "), "Number of reviews (market presence), ",
                            html.Strong("Y-axis: "), "Average sentiment score (quality). ",
                            "The highlighted point represents the selected hotel."
                        ], className="text-muted small mb-3"),
                        dcc.Graph(
...
def create_sentiment_by_nationality_chart(hotel_df, hotel_name):
    """Create enhanced sentiment analysis by nationality for a single hotel"""
    try:
        if hotel_df.empty or 'Nationality' not in hotel_df.columns or 'sentiment classification' not in hotel_df.columns:
            ...
            )        # Get nationalities for this specific hotel with at least 2 reviews
        nationality_counts = hotel_df['Nationality'].value_counts()
        # Filter nationalities with at least 2 reviews to ensure meaningful data
        top_nationalities = nationality_counts[nationality_counts >= 2].head(10).index
        
        if len(top_nationalities) == 0:
            # If no nationality has 2+ reviews, take top 5 with at least 1 review
            top_nationalities = nationality_counts[nationality_counts >= 1].head(5).index
            
        if len(top_nationalities) == 0:
            return go.Figure().add_annotation(
                text=f"No sufficient nationality data for {hotel_name}",
                xref="paper", yref="paper", x=0.5, y=0.5, showarrow=False,
                font=dict(size=16, color="gray")
            )
        ...
        # Check if sentiment is already in 0-100 scale or needs conversion from [-1,1]
        max_sentiment = nationality_sentiment['avg_sentiment'].max()
        min_sentiment = nationality_sentiment['avg_sentiment'].min()
        
        if max_sentiment <= 1.0 and min_sentiment >= -1.0:
            # Scale sentiment from [-1,1] to [0,100]
            nationality_sentiment['avg_sentiment_scaled'] = ((nationality_sentiment['avg_sentiment'] + 1) * 50).round(1)
        else:
            # Already in 0-100 scale or similar
            nationality_sentiment['avg_sentiment_scaled'] = nationality_sentiment['avg_sentiment'].round(1)
        
        # Filter out any rows with very low sentiment scores that indicate no meaningful data
        nationality_sentiment = nationality_sentiment[nationality_sentiment['avg_sentiment_scaled'] > 5]
        
        if nationality_sentiment.empty:
            return go.Figure().add_annotation(
                text="No meaningful sentiment data available for this hotel",
                xref="paper", yref="paper", x=0.5, y=0.5, showarrow=False,
                font=dict(size=16, color="gray")
            )
        
        nationality_sentiment = nationality_sentiment.sort_values('avg_sentiment_scaled', ascending=True)
        ...
        def get_sentiment_color(score):
            if score >= 80:
                ...
                return '#34D399'  # Very Good - Light Green  
            elif score >= 60:
                return '#F59E0B'  # Good - Yellow
            elif score >= 50:
                return '#F97316'  # Average - Orange
            elif score >= 40:
                return '#EF4444'  # Below Average - Red
            else:
                return '#DC2626'  # Poor - Dark Red
        
        colors = [get_sentiment_color(x) for x in nationality_sentiment['avg_sentiment_scaled']]
        
        # Create enhanced bar chart
        fig = go.Figure(data=[go.Bar(
            y=nationality_sentiment.index,
            x=nationality_sentiment['avg_sentiment_scaled'],
            orientation='h',
            marker=dict(
                color=colors,
                line=dict(color='rgba(255,255,255,0.8)', width=1),
            ),
            text=[f"<b>{x:.1f}</b>" for x in nationality_sentiment['avg_sentiment_scaled']],
            textposition='auto',
            textfont=dict(color='white', size=12, family='Inter, sans-serif'),
            hovertemplate='<b>🌍 %{y}</b><br>' +
                         'Sentiment Score: <b>%{x:.1f}/100</b><br>' +
                         'Total Reviews: <b>%{customdata}</b><br>' +
        ...
        fig.update_layout(
            title=dict(
                text=f"🌍 Sentiment Analysis by Nationality",
                font=dict(size=18, color='#1f2937', family='Inter, sans-serif'),
                x=0.02,
                xanchor='left'
            ),
            xaxis=dict(
                title="Sentiment Score (0-100 Scale)",
                range=[0, 100],
                tickmode='linear',
                tick0=0,
                dtick=20,
            ...
            height=max(400, len(nationality_sentiment) * 45),
            margin=dict(l=120, r=60, t=80, b=60),
            font=dict(family='Inter, sans-serif'),
            hovermode='y unified'
        )
        
        # Add reference lines for sentiment ranges
        fig.add_vline(x=40, line_dash="dash", line_color="rgba(239,68,68,0.4)", 
                      annotation_text="Negative", annotation_position="top")
        fig.add_vline(x=60, line_dash="dash", line_color="rgba(245,158,11,0.4)", 
                      annotation_text="Neutral", annotation_position="top")
        fig.add_vline(x=80, line_dash="dash", line_color="rgba(34,197,94,0.4)", 
        ...
        return go.Figure().add_annotation(
            text=f"Error loading nationality sentiment: {str(e)}", 
            xref="paper", yref="paper", x=0.5, y=0.5, showarrow=False,
...
def create_nationality_sentiment_chart(df):
    ...
    try:
        ...
        # Color coding based on 0-100 sentiment scale
        colors = ['#FF6B6B' if x < 40 else '#FFE66D' if x < 60 else '#4ECDC4' 
                 for x in nationality_sentiment['avg_sentiment_scaled']]
        ...
        fig = go.Figure(data=[go.Bar(
            ...
            orientation='h',
            marker=dict(color=colors, line=dict(color='white', width=1)),
            text=[f"{x:.1f}" for x in nationality_sentiment['avg_sentiment_scaled']],
            textposition='auto',
            hovertemplate='<b>%{y}</b><br>Sentiment Score: %{x:.1f}/100<br>Reviews: %{customdata}<extra></extra>',            customdata=nationality_sentiment['review_count']
        )])
        
        fig.update_layout(
            title="Average Sentiment by Nationality - Top 10 (0-100 Scale)",
            xaxis_title="Sentiment Score (0-100)",
...
def create_market_position_chart(hotel_df, city_df, hotel_name, city_name):
    ...
    try:
        ...
        if city_hotels.empty:
          ...
          # Highlight current hotel with bright, obvious colors
        hotel_colors = ['#FF1744' if idx == hotel_name else '#00E5FF' for idx in city_hotels.index]  # Bright red vs bright cyan
        hotel_sizes = [18 if idx == hotel_name else 10 for idx in city_hotels.index]  # Larger sizes for better visibility
        ...
        fig = px.scatter(
          ...
          # Update markers with enhanced visibility
        fig.update_traces(
            marker=dict(
                size=hotel_sizes,
                color=hotel_colors,
                ...
                symbol='circle'  # Ensure consistent circle shape
            )
        )
          # Add quadrant lines
        ...
        fig.update_layout(
            ...
            annotations=[
                dict(
                    text=f"🎯 {hotel_name} (Selected Hotel)",
                    xref="paper", yref="paper",
                    x=0.02, y=0.98,
                    xanchor='left', yanchor='top',
                    showarrow=False,
                    font=dict(size=12, color='#FF1744', weight='bold'),
                    bgcolor='rgba(255,255,255,0.8)',
                    bordercolor='#FF1744',
                    borderwidth=1,
                    borderpad=4
                ...
                dict(
                    text="🏨 Other Hotels in City",
                    xref="paper", yref="paper",
                    x=0.02, y=0.90,
                    xanchor='left', yanchor='top',
                    showarrow=False,
                    font=dict(size=12, color='#00E5FF', weight='bold'),
                    bgcolor='rgba(255,255,255,0.8)',
                    bordercolor='#00E5FF',
                    borderwidth=1,
                    borderpad=4
