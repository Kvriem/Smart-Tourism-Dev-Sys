...
def create_hotels_content(city_filter="all", start_date=None, end_date=None):
    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.P("🌟 Comprehensive hotel performance insights and guest satisfaction analytics", 
                   className="page-subtitle enhanced-subtitle")
...
def create_rating_distribution_chart(df):
    ...
    fig = px.bar(
        ...
        title="Guest Sentiment Distribution",
